...
import { AdaptiveMockup } from "@/app/(landing)/components/adaptive-mockup";
...
export function HeroSection() {
    return (
        <Section className={"gap-y-6 bg-background pt-12"}>
            ...
            <div
                className={
                    "flex w-full flex-col items-center gap-12 bg-secondary p-8 px-12 md:flex-row md:justify-center"
                }
            >
