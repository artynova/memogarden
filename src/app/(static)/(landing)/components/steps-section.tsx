...
/**
 * Data of a single step item in the steps section, extending the standard accordion item data with sources for the
 * image to be shown alongside the accordion.
 */
...
/**
 * Landing page steps section describing the basic steps of using the app.
 *
