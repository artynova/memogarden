...
describe(ThemeDropdown, () => {
    describe.each([{ id: "test_id" }, { id: "selector" }])("given component ID $id", ({ id }) => {
        test("should forward component ID to the dropdown trigger", () => {
    ...
    describe.each([
        ...
        test("should render current theme name inside the dropdown trigger", () => {
        ...
        test("should render the current theme option as disabled in the expanded dropdown", async () => {
            render(<ThemeDropdown theme={theme} onThemeChange={() => {}} />);
