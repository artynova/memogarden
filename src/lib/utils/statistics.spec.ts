...
describe(toSparseDatesReviews, () => {
    test.each([
        ["zero dates", [], {}],
        ["one date", [{ date: "2020-03-04", reviews: 1 }], { "2020-03-04": 1 }],
        [
            "multiple input dates",
            [
    ...
    ])("should return correct output when given input for %s", (_, entries, expected) => {
...
describe(getPastRevisionsDates, () => {
    ...
    const date = new Date("2020-03-04T02:02:00.000Z");
    ...
    ])("should return expected output when given $inputDescription", ({ mapping, expected }) => {
        const output = getPastRevisionsDates(timezone, date, mapping);
...
describe(getFutureRevisionsDates, () => {
    ...
    test.each([
        ...
        const output = getFutureRevisionsDates(timezone, date, mapping);
